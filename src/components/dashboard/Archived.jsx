...
import { Close, Info, Unarchive } from "@material-ui/icons";
...
const Archived = () => {
  ...
  const handleAllUnarchive = () => {
    ...
    setArchiveMessage("All Calls Unarchived");
    setAlertOpen(true);
  };
      ...
      {callData.map((call) => (
        <Grid item xs={12}>
          ...
          <div className={classes.demo}>
            <Paper>
              <List>
                {call.record.filter((x) => x.archived === true).length === 0 ? (
                  <div style={{ marginLeft: "24%" }}>
                    This day has unarchived calls.
                  </div>
                ) : (
                  call.record.map(
                    (record) =>
                        ...
                        <ListItem>
                          ...
                          <ListItemSecondaryAction>
                            ...
                            <IconButton
                              ...
                              onClick={() => {
                                record.archived = false;
                                setArchiveMessage("Call Unarchived");
                                setAlertOpen(true);
                              }}
                            >
                              <Unarchive />
